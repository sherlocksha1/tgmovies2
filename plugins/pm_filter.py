...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton('movies', url=f'https://t.me/new_movies_only_2022')
            ]
            ]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('updates', url='https://t.me/update_m'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        btn.insert(0,
            [InlineKeyboardButton(text="⭕️ Join Our group ⭕️",url="https://t.me/movies_hub_group_2022")]
        )
    else:
        btn.append(
        ...
        btn.insert(0,
            [InlineKeyboardButton(text="⭕️ Join Our Channel ⭕️",url="https://t.me/new_movies_club_2021")]
        )
